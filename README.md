...
| **Pod disruption budgets: minAvailable, maxUnavailable, and getting stuck** | An absolute floor vs a percentage ceiling, and a replacement pod that never becomes Ready |
